!function (t, e) {
    ...
    return function (t) {
        ...
        function o(t, e) {
            ...
            var n = function (t, e) {
                var n = [], r = e.getElementsByTagName("*"), i = new RegExp("(^|\\s)" + t + "(\\s|$)"), o = !0, A = !1,
                    a = void 0;
                try {
        ...
        function A() {
            var t = window.navigator.userAgent.toLowerCase(), e = ["msie", "firefox", "chrome", "opera", "safari"],
                n = !0, r = !1, i = void 0;
            try {
        ...
        Object.defineProperty(e, "__esModule", {value: !0});
        var a = "innerText";
        "firefox" === A() && (e.textKey = a = "textContent"), e.ready = r, e.createElement = i, e.getElementsByClassName = o, e.textKey = a
    }, function (t, e, n) {
        "use strict";
        ...
        t.exports = {
            ...
            repository: {type: "git", url: "https://github.com/greedying/tctip.git"},
        ...
        Object.defineProperty(e, "__esModule", {value: !0}), e.formatConfig = void 0;
        var A = n(16), a = "10%", c = !0, u = ["dashang", "zanzhu"], s = {id: 1, type: "dashang"}, l = {
            zanzhu: {1: n(33), 2: n(34), 3: n(35), 4: n(36), 5: n(37), 6: n(38), 7: n(39), 8: n(40), 9: n(41)},
            dashang: {1: n(24), 2: n(25), 3: n(26), 4: n(27), 5: n(28), 6: n(29), 7: n(30), 8: n(31), 9: n(32)}
        }, f = {
            alipay: {icon: n(42), name: "支付宝", desc: "支付宝进群"},
            wechat: {icon: n(45), name: "微信", desc: ""},
            bitcoin: {icon: n(43), name: "比特币", desc: "比特币进群"},
            tenpay: {icon: n(44), name: "财付通", desc: "财付通进群"}
        };
        e.formatConfig = r
    }, function (t, e, n) {
        "use strict";
        ...
        var a = function () {
            ...
            return A(e, t), a(e, [{
                key: "genDom", value: function () {
                    this.createDom({className: "tctip-main-box"}), this._title = new l.default({}, this), this._bodyBox = new p.default({list: this.config.list}, this), this._footer = new g.default({}, this)
                }
            }]), e
        }(u.default);
        ...
        var a = function () {
            ...
            return A(e, t), a(e, [{
                key: "genDom", value: function () {
                    this.createDom({className: "tctip-body-box"}), this._iconBox = new l.default({list: this.config.list}, this), this._QRDetail = new p.default(this.currentItem, this)
                }
            }, {
        ...
        var c = function () {
            ...
            return a(e, t), c(e, [{
                key: "genDom", value: function () {
                    this.createDom({className: "tctip-icon-box"}), this._iconList = new g({list: this.config.list}, this)
                }
            }]), e
            ...
            return a(e, t), c(e, [{
                key: "genDom", value: function () {
                    this.createDom({className: this.className}, "li"), this._link = new b(this.config, this)
                }
            }, {
            ...
            return a(e, t), c(e, [{
                key: "genDom", value: function () {
                    this.createDom({src: this.config.icon, alt: this.config.name}, "img")
                }
            }]), e
        }(s.default);
        e.default = h, t.exports = e.default
        ...
        var c = function () {
            ...
            return a(e, t), c(e, [{
                key: "genDom", value: function () {
                    this.createDom({className: "tctip-qr-detail"}), this._box = new b(this.config, this)
                }
            }]), e
        }(s.default), b = function (t) {
            function e(t, n) {
            ...
            return a(e, t), c(e, [{
                key: "genDom", value: function () {
                    this.createDom({className: "tctip-qr-box"}), this.genChildren()
                }
            }, {
                key: "genChildren", value: function () {
                    this._qrTitle = new y({}, this), this._qrCode = new m(this.config, this), this._qrDesc = new v({desc: this.config.desc || ""}, this)
                }
            }, {
                key: "addEvent", value: function () {
                    var t = this;
            ...
            return a(e, t), c(e, [{
                key: "genDom", value: function () {
                    this.createDom(i({className: "tctip-qr-title"}, l.textKey, "微信在这里"), "p")
                }
            }]), e
        }(s.default), m = function (t) {
            function e(t, n) {
                o(this, e);
                var r = A(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                return r.genDom(), r
            ...
            return a(e, t), c(e, [{
                ...
                key: "genQR", value: function () {
                    this.config.qrImg ? this.appendDom({src: this.config.qrImg}, "img") : this.config.qrContent ? this.dom.innerHTML = (0, p.default)(this.config.qrContent) : console.error("没有可展示的二维码")
                }
            }]), e
        }(s.default), v = function (t) {
            function e(t, n) {
                o(this, e);
                var r = A(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                return r.genDom(), r
            ...
            return a(e, t), c(e, [{
                key: "genDom", value: function () {
                    this.createDom(i({className: "tctip-qr-desc"}, l.textKey, this.config.desc), "p")
                }
            }]), e
        }(s.default);
        e.default = d, t.exports = e.default
        ...
        var c = function () {
            ...
            return a(e, t), c(e, [{
                key: "genDom", value: function () {
                    this.createDom({className: "tctip-footer"}, "p"), this._link = new p({}, this)
                }
            }]), e
        }(s.default), p = function (t) {
            function e(t, n) {
                o(this, e);
                var r = A(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                return r.genDom(), r
        ...
        var c = function () {
            ...
            return a(e, t), c(e, [{
                key: "genDom", value: function () {
                    this.createDom(i({className: "tctip-title"}, l.textKey, ""), "h1")
                }
            }]), e
        }(s.default);
        e.default = f, t.exports = e.default
        ...
        Object.defineProperty(e, "__esModule", {value: !0}), e.inArray = r, e.mergeObject = i
    }, function (t, e, n) {
        "use strict";
        ...
        var r, i, o, A = function () {
            ...
            var e = function (e, n) {
                var i = 236, A = 17, p = e, h = r[n], g = null, d = 0, y = null, m = new Array, v = {},
                    E = function (t, e) {
                        d = 4 * p + 17, g = function (t) {
                            ...
                            return e
                        }(d), w(0, 0), w(d - 7, 0), w(0, d - 7), M(), R(), B(t, e), p >= 7 && D(t), null == y && (y = U(p, h, m)), k(y, e)
                    }, w = function (t, e) {
                        for (var n = -1; n <= 7; n += 1) if (!(t + n <= -1 || d <= t + n)) for (var r = -1; r <= 7; r += 1) e + r <= -1 || d <= e + r || (0 <= n && n <= 6 && (0 == r || 6 == r) || 0 <= r && r <= 6 && (0 == n || 6 == n) || 2 <= n && n <= 4 && 2 <= r && r <= 4 ? g[t + n][e + r] = !0 : g[t + n][e + r] = !1)
                    }, I = function () {
                        ...
                        for (var t = o.getPatternPosition(p), e = 0; e < t.length; e += 1) for (var n = 0; n < t.length; n += 1) {
                            var r = t[e], i = t[n];
                            if (null == g[r][i]) for (var A = -2; A <= 2; A += 1) for (var a = -2; a <= 2; a += 1) A == -2 || 2 == A || a == -2 || 2 == a || 0 == A && 0 == a ? g[r + A][i + a] = !0 : g[r + A][i + a] = !1
                        }
                    }, D = function (t) {
                        ...
                        for (var n = -1, r = d - 1, i = 7, A = 0, a = o.getMaskFunction(e), c = d - 1; c > 0; c -= 2) for (6 == c && (c -= 1); ;) {
                        ...
                        for (var y = new Array(b), m = 0, f = 0; f < i; f += 1) for (var u = 0; u < n.length; u += 1) f < a[u].length && (y[m] = a[u][f], m += 1);
                        for (var f = 0; f < A; f += 1) for (var u = 0; u < n.length; u += 1) f < c[u].length && (y[m] = c[u][f], m += 1);
                        return y
                    }, U = function (t, e, n) {
                ...
                return v.addData = function (t, e) {
                    ...
                    for (A = "l" + t + ",0 0," + t + " -" + t + ",0 0,-" + t + "z ", c += "<svg", c += ' width="' + a + 'px"', c += ' height="' + a + 'px"', c += ' xmlns="http://www.w3.org/2000/svg"', c += ">", c += '<path d="', i = 0; i < v.getModuleCount(); i += 1) for (o = i * t + e, n = 0; n < v.getModuleCount(); n += 1) v.isDark(i, n) && (r = n * t + e, c += "M" + r + "," + o + A);
            ...
            var n = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, r = {L: 1, M: 0, Q: 3, H: 2},
                i = {
                    PATTERN000: 0,
                    PATTERN001: 1,
                    PATTERN010: 2,
                    ...
                    var e = [[], [6, 18], [6, 22], [6, 26], [6, 30], [6, 34], [6, 22, 38], [6, 24, 42], [6, 26, 46], [6, 28, 50], [6, 30, 54], [6, 32, 58], [6, 34, 62], [6, 26, 46, 66], [6, 26, 48, 70], [6, 26, 50, 74], [6, 30, 54, 78], [6, 30, 56, 82], [6, 30, 58, 86], [6, 34, 62, 90], [6, 28, 50, 72, 94], [6, 26, 50, 74, 98], [6, 30, 54, 78, 102], [6, 28, 54, 80, 106], [6, 32, 58, 84, 110], [6, 30, 58, 86, 114], [6, 34, 62, 90, 118], [6, 26, 50, 74, 98, 122], [6, 30, 54, 78, 102, 126], [6, 26, 52, 78, 104, 130], [6, 30, 56, 82, 108, 134], [6, 34, 60, 86, 112, 138], [6, 30, 58, 86, 114, 142], [6, 34, 62, 90, 118, 146], [6, 30, 54, 78, 102, 126, 150], [6, 24, 50, 76, 102, 128, 154], [6, 28, 54, 80, 106, 132, 158], [6, 32, 58, 84, 110, 136, 162], [6, 26, 54, 82, 110, 138, 166], [6, 30, 58, 86, 114, 142, 170]],
                        r = 1335, o = 7973, a = 21522, c = {}, u = function (t) {
                    ...
                    return c.getBCHTypeInfo = function (t) {
                        ...
                        for (var e = t.getModuleCount(), n = 0, r = 0; r < e; r += 1) for (var i = 0; i < e; i += 1) {
                            for (var o = 0, A = t.isDark(r, i), a = -1; a <= 1; a += 1) if (!(r + a < 0 || e <= r + a)) for (var c = -1; c <= 1; c += 1) i + c < 0 || e <= i + c || 0 == a && 0 == c || A == t.isDark(r + a, i + c) && (o += 1);
                            o > 5 && (n += 3 + o - 5)
                        }
                        ...
                        for (var s = 0, i = 0; i < e; i += 1) for (var r = 0; r < e; r += 1) t.isDark(r, i) && (s += 1);
                    ...
                    return n.getRSBlocks = function (t, n) {
                        ...
                        for (var o = r.length / 3, A = new Array, a = 0; a < o; a += 1) for (var c = r[3 * a + 0], u = r[3 * a + 1], s = r[3 * a + 2], l = 0; l < c; l += 1) A.push(e(u, s));
                        return A
                    }, n
                }(), c = function () {
                    ...
                    i.getMode = function () {
                        ...
                        for (var e = r, n = 0; n + 1 < e.length;) t.put(45 * o(e.charAt(n)) + o(e.charAt(n + 1)), 11), n += 2;
                    ...
                    return i.writeByte = function (r) {
                        ...
                        if (e > 0 && (o(t << 6 - e), t = 0, e = 0), n % 3 != 0) for (var i = 3 - n % 3, A = 0; A < i; A += 1) r += "="
                    }, i.toString = function () {
                        return r
                    }, i
                }, g = function (t) {
                    ...
                    var A = function (t) {
                        ...
                        for (var e = 1 << t, n = (1 << t) + 1, r = t + 1, o = c(), a = 0; a < e; a += 1) o.add(String.fromCharCode(a));
                    ...
                    c.flush();
                    var l = "";
                    return l += "<img", l += ' src="', l += "data:image/gif;base64,", l += c, l += '"', l += ' width="', l += t, l += '"', l += ' height="', l += e, l += '"', r && (l += ' alt="', l += r, l += '"'), l += "/>"
                };
            return e
        }();
        !function (n) {
        ...
        function r(t) {
            for (var e = [], n = {}, r = 0; r < t.length; r++) {
                var i = t[r], o = i[0], A = i[1], a = i[2], c = i[3], u = {css: A, media: a, sourceMap: c};
