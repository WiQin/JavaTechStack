...
public class PublishRecver1 {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * 3、路由key
         */
        channel.queueBind(QueueEnum.PUBLISH_SUBSCRIBE_1.getCode(), ExchangeEnum.FANOOUT_INFORM.getCode(), "");
        //定义消费方法
         ...
         */
        channel.basicConsume(QueueEnum.PUBLISH_SUBSCRIBE_1.getCode(), true, defaultConsumer);
    }
}
